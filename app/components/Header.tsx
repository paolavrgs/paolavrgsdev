...
const Header = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-between items-center py-16 md:py-24 px-8 md:px-14 lg:px-20 h-auto min-h-unset md:min-h-screen md:h-screen gap-20 lg:gap-0">
      ...
      <div className="w-full lg:w-1/2 relative h-[300px] md:h-[450px] lg:h-[600px]">
        <Image src="/portrait_1.jpg" alt="Portrait" fill style={{ objectFit: 'cover', objectPosition: "center 35%" }} className="rounded-xl" />
      </div>
    </div>
  );
};
